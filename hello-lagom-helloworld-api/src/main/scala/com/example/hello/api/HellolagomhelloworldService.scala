...
object HellolagomhelloworldService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The hello-lagom-HelloWorld service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HellolagomhelloworldService.
  */
trait HellolagomhelloworldService extends Service {
  ...
  override final def descriptor = {
    import Service._
    // @formatter:off
    named("hello-lagom-helloworld")
      .withCalls(
        pathCall("/api/hello/:id", hello _),
        pathCall("/api/hello/:id", useGreeting _)
      )
      .withTopics(
        topic(HellolagomhelloworldService.TOPIC_NAME, greetingsTopic _)
